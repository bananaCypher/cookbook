...
# Recipies
Recipie.delete_all
soup = Recipie.new(name: 'Lentil Soup', description: 'Lentil soup is comforting, simple, and easy to throw together with the bare minimum of ingredients.', instructions: "
...
beef = Recipie.new(name: 'Roast Beef', description: 'Roast beef is a signature national dish of England and holds cultural meaning for the English.', instructions: "
...
beef.category = main_course
beef.save

banofee_pie = Recipie.new(name: 'Banofee Pie', description: 'Arguably the best dessert in the world!.', instructions: "
